...
// Tu código acá:   
let nombreCompleto = document.querySelector('#createdBy');
 nombreCompleto.innerHTML  += 'Braian';
...
function displayToDos() {
  ...
  buildToDos(toDoItems).forEach(function(arg){
    toDoContainer.appendChild(arg)
  })
}
